...
/**
 * Component tests for the 5-tab library nav (App Surfaces design).
 *
 ...
 *   - It is the ONLY way to move between the library surfaces, so all five tabs
 *     (Today/Archive/Sources/Thirty/Settings) must be present in design order.
...
describe("TabBar", () => {
  it("renders all five tabs in design order (Today · Archive · Sources · Thirty · Settings)", () => {
    ...
    expect(labels).toEqual(["Today", "Archive", "Sources", "Thirty", "Settings"]);
  });
